...
print(os.path.exists(os.path.abspath('../exts/helloworld.py')))

# -- Project information -----------------------------------------------------

project = "How to search for hyper parameters"
copyright = "2022, ENCCS Hyper Parameter Optimization Workshop and individual contributors."
author = "ENCCS Hyper Parameter Optimization Workshop and individual contributors."
github_user = "ENCCS"
github_repo_name = "hp_optimization"
github_version = "main"
